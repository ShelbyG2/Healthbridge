...
<nav className='absolute   h-full bg-light-bg-shape2 lg:relative lg:mt-4 lg:h-1/2 lg:rounded-r-xl md:relative lg:txt-xl left-0'>
            ...
            <ul className='hidden sm:flex flex-col gap-4 p-4 -shape2 rounded-lg  text-white dark:text-dark-text'>
                ...
                <li className='flex items-center gap-2  bg-light-bg-highlight dark:bg-dark-bg-highlight p-2 rounded-md bg-opacity-20 hover:bg-light-hover dark:hover:bg-dark-hover' ><Clock /> Patients</li>
                <li className='flex items-center gap-2  bg-light-bg-highlight dark:bg-dark-bg-highlight p-2 rounded-md bg-opacity-20 hover:bg-light-hover dark:hover:bg-dark-hover' >Referrals</li>
