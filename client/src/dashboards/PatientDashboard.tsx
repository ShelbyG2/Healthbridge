...
const PatientDashboard = () => {
  ...
  return (
    <main className='main-container   gap-4  dark:bg-dark-bg min-h-screen  '>
      <nav>
        <PatientNavBar />
      </nav>
      <div className="flex-1 justify-center p-6  w-full" >
        ...
        <section className="main-container ">
          ...
          <div className="flex-grow p-6 rounded-lg shadow-lg bg-gradient-to-br from-white to-light-border dark:from-dark-surface dark:to-dark-bg min-h-fit border border-light-border dark:border-dark-border">
            <h2 className="text-xl font-semibold text-light-text dark:text-dark-text mb-4">Quick Stats</h2>
            <div className="grid grid-cols-2 gap-4 mt-4">
              <div className="bg-white dark:bg-dark-surface p-4 rounded-lg shadow-md border-l-4 border-light-accent dark:border-dark-accent transition-transform duration-300 hover:scale-105">
                ...
                <p className="text-3xl font-bold text-light-accent dark:text-dark-accent">5</p>
              </div>
              <div className="bg-white dark:bg-dark-surface p-4 rounded-lg shadow-md border-l-4 border-light-success dark:border-dark-success transition-transform duration-300 hover:scale-105">
                ...
                <div className="bg-white dark:bg-dark-surface p-4 rounded-lg shadow-md border-l-4 border-light-logo-blue dark:border-dark-logo-blue transition-transform duration-300 hover:scale-105">
                  <h3 className="text-lg font-medium text-light-text dark:text-dark-text">Medical Adherence</h3>
...
<div className="bg-gradient-to-br from-light-accent/10 to-light-accent/20 dark:from-dark-accent/10 dark:to-dark-accent/20 p-6 rounded-xl shadow-lg hover:shadow-xl flex-grow transition-transform duration-300 hover:scale-105 border border-light-accent/30 dark:border-dark-accent/30">
  ...
  <div className="space-y-3">
    ...
    <div className="text-light-secondary dark:text-dark-secondary space-y-1">
      <p className="flex items-center gap-2"><Clock className="w-4 h-4 text-light-accent dark:text-dark-accent" /> 2023-10-01</p>
      <p className="flex items-center gap-2"><Clock className="w-4 h-4 text-light-accent dark:text-dark-accent" /> 10:00 AM</p>
    </div>
      ...
      View Details
          ...
          <div className="bg-gradient-to-br from-white to-light-border/30 dark:from-dark-surface dark:to-dark-bg p-6 rounded-xl flex-grow shadow-lg hover:shadow-xl duration-300 transition-transform hover:scale-105 border border-light-border dark:border-dark-border">
            ...
            <div className="space-y-3">
              {triageResults.map(result => (
                <div key={result.id} className="bg-white dark:bg-dark-surface/80 border border-light-border/50 dark:border-dark-border/50 p-4 rounded-lg shadow-sm">
                  ...
                  <div className="text-light-secondary dark:text-dark-secondary space-y-1 text-sm">
                    <p>Urgency: <span className="font-semibold text-light-error dark:text-dark-error">{result.urgency}</span></p>
          ...
          <div className="bg-gradient-to-br from-white to-light-border/30 dark:from-dark-surface dark:to-dark-bg p-6 rounded-xl shadow-lg hover:shadow-xl transition-transform flex-grow duration-300 hover:scale-105 border border-light-border dark:border-dark-border">
            ...
            <div className="flex flex-col items-center space-y-3">
              <div className="rounded-full w-24 h-24 p-1 bg-gradient-to-r from-light-accent to-light-success dark:from-dark-accent dark:to-dark-success">
                <img src={Doctor} alt="Doctor" className="rounded-full w-full h-full object-cover" />
              </div>
              ...
              <p className="flex items-center gap-2 text-light-secondary dark:text-dark-secondary">
                <PhoneCallIcon className="w-4 h-4 text-light-success dark:text-dark-success" /> (123) 456-7890
              </p>
          ...
          <div className="bg-gradient-to-br from-white to-light-border/30 dark:from-dark-surface dark:to-dark-bg p-6 rounded-xl shadow-lg hover:shadow-xl transition-transform flex-grow duration-300 hover:scale-105 border border-light-border dark:border-dark-border">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-semibold text-light-text dark:text-dark-text">Health Tracker</h2>
            </div>
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 rounded-full bg-light-accent dark:bg-dark-accent"></div>
                <p className='text-light-secondary dark:text-dark-secondary'>Next Dosage: <span className="text-light-text dark:text-dark-text font-medium">10:00 AM</span></p>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 rounded-full bg-light-success dark:bg-dark-success"></div>
                <p className='text-light-secondary dark:text-dark-secondary'>Last Checkup: <span className="text-light-text dark:text-dark-text font-medium">2023-09-15</span></p>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 rounded-full bg-light-logo-blue dark:bg-dark-logo-blue"></div>
                <p className='text-light-secondary dark:text-dark-secondary'>Next Checkup: <span className="text-light-text dark:text-dark-text font-medium">2023-10-15</span></p>
              </div>
          ...
          <div className="bg-gradient-to-br from-white to-light-border/30 dark:from-dark-surface dark:to-dark-bg p-6 rounded-xl shadow-lg hover:shadow-xl transition-transform flex-grow duration-300 hover:scale-105 border border-light-border dark:border-dark-border">
            ...
            <div className="space-y-2 max-h-[300px] overflow-y-auto pr-1">
              {messages.map(message => (
                <div key={message.id} className="bg-white dark:bg-dark-surface/80 border border-light-border/50 dark:border-dark-border/50 p-3 rounded-lg shadow-sm">
                  <p className="text-light-text dark:text-dark-text text-sm">{message.text}</p>
                  <div className="flex justify-end">
                    <span className="text-light-accent dark:text-dark-accent text-xs font-medium">{message.time}</span>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="bg-light-surface dark:bg-dark-surface p-6 rounded-xl shadow-lg hover:shadow-xl transition-transform flex-grow duration-300 h-fit hover:scale-105">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-semibold text-light-text dark:text-dark-text">Doctors Next Available</h2>
            </div>
            <ul className="space-y-2">
              <li className="text-light-secondary dark:text-dark-secondary">Dr. Smith - 10:00 AM</li>
              <li className="text-light-secondary dark:text-dark-secondary"> Dr. Johnson - 11:30 AM</li>
              <li className="text-light-secondary dark:text-dark-secondary">Dr. Lee - 1:00 PM</li>
              <li className="text-light-secondary dark:text-dark-secondary"> Dr. Patel - 2:30 PM</li>
            </ul>
          </div>
